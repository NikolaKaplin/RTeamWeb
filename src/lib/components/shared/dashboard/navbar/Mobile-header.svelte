...
<header
	class="fixed left-0 right-0 top-0 z-10 flex items-center justify-between bg-gray-800 p-2 drop-shadow-xl lg:hidden"
>
	<div class="w-7"></div>
	<a href="/" class="absolute left-1/2 flex -translate-x-1/2 transform items-center space-x-2">
